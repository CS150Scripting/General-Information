'==========================================================================
' NAME: <searchTXTmultiValuesSolution.vbs>
...
Dim i 
intSize = 0 
myFile = "c:\windows\setuplog.txt" 'Ensure location
...
Loop
	objTextFile.close
WScript.Echo funLine("There are " & ubound(arrTxtArray) & " Lines with " & Item & " in them")
