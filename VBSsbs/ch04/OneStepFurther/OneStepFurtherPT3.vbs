...
'
' NAME: <OneStepFurtherPT3.vbs>
'
' AUTHOR: ed wilson , mred
' DATE  : 6/26/2006
'
' COMMENT: <This script will run. It is however, incomplete. It covers up to>
'					<Step 10 in the one step further exercise for chapter four>
